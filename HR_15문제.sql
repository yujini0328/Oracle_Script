...
select ename 이름, salary 급여, commission 커밋션
from employee
...
-- job asc, ename desc
-- 두개 시상의 컬럼이 정렬될때, job 컬럼을 정렬후, job 컬럼의 중복된 값에 대해서 ename desc 정렬됨
select *
from employee
